...
public:
    ...
    virtual ~TransferFcn();
    virtual PUnitModule Get_InputPort(uint32_t n=0) const override;
    virtual PUnitModule Get_OutputPort(uint32_t n=0) const override;
...
public:
    ...
    virtual PMatModule Get_InputBus(uint32_t n=0) const override;
    virtual PMatModule Get_OutputBus(uint32_t n=0) const override;
