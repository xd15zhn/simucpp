...
void Simulator::connectU(PUnitModule m1, PPackModule m2, uint32_t n2) {  // unit to pack
...
void Simulator::connectU(PPackModule m1, uint32_t n1, PUnitModule m2) {  // pack to unit
...
void Simulator::connectU(PPackModule m1, uint32_t n1, PPackModule m2, uint32_t n2) {  // pack to pack
...
void Simulator::connectM(PMatModule m1, PPackModule m2, uint32_t n2) {  // mat to pack
...
void Simulator::connectM(PPackModule m1, uint32_t n1, PMatModule m2) {  // pack to mat
...
void Simulator::connectM(PPackModule m1, uint32_t n1, PPackModule m2, uint32_t n2) {  // pack to pack
    CHECK_NULLPTR(m1, PackModule); CHECK_NULLPTR(m2, PackModule);
...
void Simulator::connectU(PPackModule m1, uint32_t n1, PMux m2, BusSize n2) {  // pack to nux
...
void Simulator::connectU(PDeMux m1, BusSize n1, PPackModule m2, uint32_t n2) {  // demux to pack
