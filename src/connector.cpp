...
void Simulator::connectU(PUnitModule m1, PPackModule m2, int n2) {  // unit to pack
...
void Simulator::connectU(PPackModule m1, int n1, PUnitModule m2) {  // pack to unit
    CHECK_NULLPTR(m1);
...
void Simulator::connectU(PPackModule m1, int n1, PPackModule m2, int n2) {  // pack to pack
    CHECK_NULLPTR(m1); CHECK_NULLPTR(m2);
    PUnitModule bm1 = m1->Get_OutputPort(n1);
    PUnitModule bm2 = m2->Get_InputPort(n2);
    CHECK_NULLPTR(bm1); CHECK_NULLID(bm1); CHECK_SIMULATOR(bm1);
...
void Simulator::connectM(PMatModule m1, PPackModule m2, int n2) {  // mat to pack
    CHECK_NULLPTR(m1); CHECK_NULLPTR(m2);
    CHECK_SIMULATOR(m1);
...
void Simulator::connectM(PPackModule m1, int n1, PMatModule m2) {  // pack to mat
    CHECK_NULLPTR(m1); CHECK_NULLPTR(m2);
    CHECK_SIMULATOR(m2);
...
void Simulator::connectM(PPackModule m1, int n1, PPackModule m2, int n2) {  // pack to pack
    CHECK_NULLPTR(m1); CHECK_NULLPTR(m2);
